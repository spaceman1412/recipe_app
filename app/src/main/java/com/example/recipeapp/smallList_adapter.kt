...
class SmallAdapter() : RecyclerView.Adapter<SmallAdapter.ViewHolder>(){
    data class SmallItem(val imgUrl: String, val itemName: String)

    val listItems : List<SmallItem>  = listOf<SmallItem>(SmallItem("https://static.toiimg.com/thumb/54478818.cms?width=1200&height=900","Hotdog"),
        SmallItem("http://assets.epicurious.com/photos/57c5c6d9cf9e9ad43de2d96e/master/pass/the-ultimate-hamburger.jpg","Hamburger"),SmallItem("https://www.acouplecooks.com/wp-content/uploads/2019/05/Chopped-Salad-001_1.jpg","Salad"))
